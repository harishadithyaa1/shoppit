...
def add_item(request):
    try:
        ...
        return Response({"error": str(0)}, status=400)
...
def payment_callback(request):
    ...
    if status == 'successful':
        ...
        if response_data['status'] == 'success':
            ...
            return Response({'message': 'Failed to verify transaction with Flutterwave.', "subMessage": "We couldn't able to complete payment"})
    else:
